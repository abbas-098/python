...
def app():
    ...
    # gathering all the inputed data from the course

    # the nested for loop works by first executing the first outer iteration. the first itertation then triggers the inner nested loop to completion. 
    # then it returns to outer loop for second iteration.
